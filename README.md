...
## 프로젝트 기본 정보
- 프로젝트 이름: 이디야와 스타벅스 매장 위치의 관계 분석
- 프로젝트 기간: 2024.11.21 ~ 2024.12.20
- 개인 프로젝트
- 사용 언어 및 : Python, Amazon RDS (MySQL), Tableau
...
## 프로젝트 설명
스타벅스 인접 입지를 노린다는 가설을 바탕으로, 서울시 이디야커피와 스타벅스 매장 데이터를 분석한 프로젝트

## EDA
### 브랜드별 서울 지역 전체 매장 수
![스크린샷 2024-07-18 235739]![스크린샷 2024-07-18 235739](https://github.com/user-attachments/assets/e32e59ef-a580-4598-918b-a880a7cfcd65)
### 자치구별 스타벅스와 이디야 매장 수 비교
...
## Lesson & Learned
- 하나의 프로젝트에서 MySQL, Python, Tableau와 같이 여러 프로그램을 사용하는방법을 익힘.
- 분석 단계별 사용할 수 있는 프로그램과 그의 장점을 알고 효율적으로 수행할 수 있었음.
- AWS 서버에서 MySQL 데이터베이스를 생성하고 다루는 것을 배움.
- Python을 활용하여 MySQL을 사용하는 것을 익힘.
- 가설을 설정하고 분석을 통해 가설을 검증해 나가는 것을 배울 수 있었음.
- Tableau를 활용하여 표현하고자 하는 것을 대시보드로 표현하는 것을 익힘.
